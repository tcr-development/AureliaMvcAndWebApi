...
declare module wijmo.grid {
    ...
    */
    class FlexGrid extends Control {
        ...
        */
        public showSelectedHeaders : HeadersVisibility;
        /**
        * Gets or sets a value that indicates whether the grid shouuld
        * display a marquee element around the current selection.
        */
        public showMarquee : boolean;
        /**
        ...
        * @param invalidate A value indicating whether to invalidate the grid to show the change.
        * @return True if the value was stored successfully, false otherwise.
        */
        public setCellData(r: number, c: any, value: any, coerce?: boolean, invalidate?: boolean): boolean;
        /**
        ...
        */
        public refreshCells(fullUpdate: boolean, recycle?: boolean, state?: boolean): void;
        /**
        ...
        */
        public onLoadingRows(e: CancelEventArgs): boolean;
        /**
...
declare module wijmo.grid {
    ...
    */
    class GridPanel {
        ...
        */
        public getCellBoundingRect(r: number, c: number, raw?: boolean): Rect;
        /**
        * Gets a @see:SelectedState value that indicates the selected state of a cell.
        *
        * @param r Row index of the cell to inspect.
        ...
        */
        ...
        public _updateContent(recycle: boolean, state: boolean, offsetY: number): void;
        public _reorderCells(newRange: CellRange, oldRange: CellRange): void;
        public _renderRow(r: number, vrng: CellRange, frozen: boolean, state: boolean, ctr: number): number;
...
declare module wijmo.grid {
    ...
    */
    class CellFactory {
        ...
        */
        public updateCell(panel: GridPanel, r: number, c: number, cell: HTMLElement, rng?: CellRange, updateContent?: boolean): void;
    ...
    */
    class RowCol {
        ...
        */
        public isReadOnly : boolean;
        /**
        * Gets or sets a value indicating whether cells in this row or column
...
declare module wijmo.grid {
    ...
    */
    class HitTestInfo {
        ...
        * Gets the grid panel at the specified position.
        *
        * This property is deprecated. Please use the @see:panel property instead.
        */
        public gridPanel : GridPanel;
        /**
        * Gets the cell range at the specified position.
        *
        * This property is deprecated. Please use the @see:range property instead.
        */
        public cellRange : CellRange;
    }
}
