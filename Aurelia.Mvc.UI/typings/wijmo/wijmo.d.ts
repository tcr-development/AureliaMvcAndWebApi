...
declare module wijmo {
    ...
    */
    class Globalize {
        ...
        *  currencly values for cultures different than the current default
        ...
        */
        static formatNumber(value: number, format: string, trim?: boolean): string;
        /**
...
declare module wijmo {
    ...
    */
    class Control {
        ...
        */
        public addEventListener(target: EventTarget, type: string, fn: any, capture?: boolean): void;
        /**
        ...
        */
        public removeEventListener(target?: EventTarget, type?: string, capture?: boolean): void;
        /**
        * Occurs when the control gets the focus.
        */
        public gotFocus: Event;
        /**
...
declare module wijmo.collections {
    ...
    */
    class CollectionView implements IEditableCollectionView, IPagedCollectionView {
        ...
        */
        public removeAt(index: number): void;
        public _extend(dst: any, src: any): void;
...
declare module wijmo {
    ...
    * @param ref Reference rectangle used to position the popup.
    ...
    */
    function showPopup(popup: HTMLElement, ref?: any, above?: boolean, fadeIn?: boolean): void;
    /**
    ...
    */
    function hidePopup(popup: HTMLElement, remove?: boolean, fadeOut?: boolean): void;
}
